...
void loop() {
  ...
  /*Alarm.alarmRepeat(dowMonday, alarmaHora, alarmaMinutos, 0, alarma);
    Alarm.alarmRepeat(dowTuesday, alarmaHora, alarmaMinutos, 0, alarma);
  ...
  {
    showTime();
    //Serial.print("millis  e inicio:"); Serial.print(millis()); Serial.printf(" \t"); Serial.println(inicio);
